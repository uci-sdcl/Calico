...
public class ByteUtils
{
	...
	public static final int SIZE_OF_CHAR = SIZE_OF_SHORT;
	...
	/**
	 * Read a char from the byte array starting at the given offset
	 * 
	 * @param bytes The byte array to read from
	 * @param offset The offset to start reading at
	...
	/**
	 * Write a char to the byte array starting at the given offset
	 * 
	 * @param bytes The byte array
	 * @param value The char to write
	 * @param offset The offset to begin writing at
	 */
	public static void writeChar(byte[] bytes, char value, int offset)
	{
		bytes[offset] = (byte) (0xFF & (value >> 8));
		bytes[offset + 1] = (byte) (0xFF & value);
	}
